...
COMPONENT_NAME ?= openshift4-console
...
instance ?= defaults
test_instances = tests/defaults.yml test/custom-plugins.yml tests/custom-route.yml tests/custom-route-4.7.yml tests/custom-route-legacy.yml tests/custom-route-legacy-4.7.yml tests/custom-route-managed-tls.yml tests/custom-links.yml tests/custom-logo.yml
