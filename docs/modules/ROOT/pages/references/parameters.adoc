...
When upgrade notifications are enabled, this component will create an Espejote ManagedResource which will dynamically create (and remove) a `ConsoleNotification` informing users about the next upcoming minor OCP upgrade.
